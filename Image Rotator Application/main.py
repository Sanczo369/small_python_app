...
class Image_Rotator:
    def __init__(self, root):
        ...
        left_btn = Button(self.window, text="Left", font=("Helvetica", 15, 'bold'), command=self.rotate_left)
        left_btn.place(x=15, y=270)

        right_btn = Button(self.window, text="Right", font=("Helvetica", 15, 'bold'), command=self.rotate_right)
    ...
    # About window
    def about(self):
        messagebox.showinfo("Image Rotator", "Image Rotator AppnDeveloped by Subhankar Rakshit")
