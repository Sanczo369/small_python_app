...
Button(root,text="C",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3967f5",command=lambda: clear()).place(x=10,y=100)
...
Button(root,text="7",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3967f5",command=lambda: show("7")).place(x=10,y=200)
...
Button(root,text="4",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3967f5",command=lambda: show("4")).place(x=10,y=300)
...
Button(root,text="1",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3967f5",command=lambda: show("1")).place(x=10,y=400)
