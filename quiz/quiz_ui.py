...
class QuizInterface:
    ...
    def radio_buttons(self):
        """Generowanie 4 opcji (radio buttons)"""
    ...
    def next_btn(self):
        """feedback po każdej odpowiedzi i sprawdza, czy nie ma więcej pytań"""
    ...
    def buttons(self):
        """wyświetla next button i quit button"""
    ...
    def display_result(self):
        """wyświetlenie rezultatu(messagebox)"""
